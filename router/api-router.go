...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/verification", middleware.EmailVerificationRateLimit(), middleware.AliyunCaptchaCheck(), controller.SendEmailVerification)
		apiRouter.GET("/reset_password", middleware.CriticalRateLimit(), middleware.AliyunCaptchaCheck(), controller.SendPasswordResetEmail)
		...
		{
			userRoute.POST("/register", middleware.CriticalRateLimit(), middleware.AliyunCaptchaCheck(), controller.Register)
			userRoute.POST("/login", middleware.CriticalRateLimit(), middleware.AliyunCaptchaCheck(), controller.Login)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/checkin", middleware.AliyunCaptchaCheck(), controller.DoCheckin)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/direct-pay/wechat-native/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestWechatNativePay)
			subscriptionRoute.POST("/direct-pay/alipay/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestAlipayPay)
		}
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.POST("/batch-disable", controller.BatchDisableRedemptions)
